...
from myapps.apps.views import apps_calendar_view, apps_chat_view, apps_email_inbox_view,apps_email_read,apps_tasks,apps_tasks_details,apps_kanban_board,apps_file_manager
